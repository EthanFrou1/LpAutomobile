...
/**
 * Return true, if the value is a valid vehicule identification number (VIN).
 *
 * Works with all kind of text inputs.
 *
 * @example <input type="text" size="20" name="vehiculeID" class="{required:true,vinUS:true}" />
 * @desc Declares a required input element whose value must be a valid vehicule identification number.
 *
...
$.validator.addMethod( "vinUS", function( v ) {
	...
	return false;
}, "The specified vehicule identification number (VIN) is invalid." );
